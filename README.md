...
# Installation
1. PARAOB is available in .py format. Download the latest version in the 'Releases' section.
2. Open Blender.
...
# Usage (for further information, consult the 'Before Rendering Checklist' in the add-on.)
1. Ensure the model is properly positioned in the scene.
2. Customize rendering settings directly within the add-on's panel.
3. Press the 'Render Selected Viewpoints'
4. Wait for the rendering task to complete.
